...
VALUES
('2023000000001', 'Hospital A', 1, '2025-01-10', '01', 'LIC123', 'Dr. Smith', 'General Physician', 'Healthy', 'https://example.com/doc1.pdf', FALSE, 2, '2025-01-14'),
('2023000000002', 'Hospital B', 2, '2025-01-11', '02', 'LIC456', 'Dr. Brown', 'Surgeon', 'Requires follow-up.', 'https://example.com/doc2.pdf', FALSE, 2, '2025-01-14'),
('2023000000003', 'Hospital C', 3, '2025-01-12', '03', 'LIC789', 'Dr. White', 'Cardiologist', 'Failed health check.', 'https://example.com/doc3.pdf', FALSE, 2, '2025-01-14');
