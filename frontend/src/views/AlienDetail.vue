<template>
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <!-- Form -->
        <form v-else @submit.prevent="saveDetail" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <!-- ข้อมูลส่วนตัว -->
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input v-model="form.alcode" type="text" disabled
                    ...
                    <div>
                        ...
                        <select v-model="form.alprefix_th"
                            class="border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <option value="">เลือกคำนำหน้า</option>
                ...
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input v-model="form.subdistrict" type="text" class="border rounded w-full py-2 px-3">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input v-model="form.postal_code" type="text" class="border rounded w-full py-2 px-3">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea v-model="form.remark" class="border rounded w-full py-2 px-3" rows="3"></textarea>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.healthCheck.alchkhos" type="text" maxlength="100"
                    ...
                    <div>
                        ...
                        <select v-model="form.healthCheck.alchkprovid"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div>
                        ...
                        <input v-model="form.healthCheck.licenseno" type="text" maxlength="50"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">
                        ...
                        <input v-model="form.healthCheck.chkname" type="text" maxlength="100"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">
                        ...
                        <select v-model="form.healthCheck.alchkstatus"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div>
                        ...
                        <input v-model="form.healthCheck.chkposition" type="text" maxlength="50"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div class="col-span-2">
                        ...
                        <textarea v-model="form.healthCheck.alchkdesc" rows="3" maxlength="500"
                    ...
                    <div class="col-span-2">
                        ...
                        <input v-model="form.healthCheck.alchkdoc" type="text" maxlength="200"
                            class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                </div>
            </div>
